/* data-fixed.js
   FINAL CORRECTED VERSION - ISRAEL MARKET 2025
   - Fixed SP Target: 12,000 points (aligned top & bottom).
   - Fixed SP Commission: 19% (14% + 5%).
   - Fixed SC Target: 28,000 points.
   - Fixed SC Commission: 22% (19% + 3%).
*/
...
window.RANKS = [
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> צבירת 4,000 נקודות פרומו (ניתן לצבור ללא הגבלת זמן, או 1,000 בחודש אחד למסלול מהיר).</li><li><b>מבנה:</b> צירוף שותף אחד חדש או לקוח אישי אחד לפחות.</li></ul>",
        commissions: "10% עמלת מכירה (Retail) <br>+ <b>4% עמלה נוספת</b> (סה״כ 14%).",
  ...
  },
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> 12,000 נקודות פרומו (בחלון של חודשיים).</li><li><b>חוק 50%:</b> מקסימום 6,000 נקודות נחשבות מרגל אחת.</li><li><b>מבנה:</b> 3 שותפים ישירים (עם הזמנה) או רגל אחת בדרגת P+.</li></ul>",
        commissions: "14% עמלת בסיס (כ-P+)<br>+ <b>5% בונוס ביצוע</b> (PB)<br>= <b>סה״כ 19%</b>.",
  ...
  },
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> 28,000 נקודות פרומו (בחלון של חודשיים).</li><li><b>חוק 50%:</b> מקסימום 14,000 נקודות מרגל אחת.</li><li><b>מבנה:</b> 2 רגליים פעילות (אחת Senior Partner, אחת Partner Plus).</li></ul>",
        commissions: "19% עמלת בסיס (כ-SP)<br>+ <b>3% בונוס קידום</b> (POB)<br>= <b>סה״כ 22%</b>.<br>+ זכאות לעמלות דורות (BIB).",
  ...
  },
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> 56,000 נקודות פרומו.</li><li><b>מבנה:</b> 2 רגליים (אחת SC, אחת SP).</li></ul>",
  ...
  },
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> 111,000 נקודות פרומו.</li><li><b>מבנה:</b> 3 רגליים (אחת QSSC, שתיים SP).</li></ul>",
  ...
  },
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> 222,000 נקודות פרומו.</li><li><b>מבנה:</b> 3 רגליים (אחת SSC, שתיים SC).</li></ul>",
  ...
  },
  {
    ...
    fullDetails: {
        requirements: "<ul><li><b>יעד:</b> 222,000 נקודות (יציבות).</li><li><b>מבנה:</b> 4 רגליים (אחת QNMD, אחת SSC, שתיים SC).</li></ul>",
