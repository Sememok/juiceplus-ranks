...
window.PRODUCTS = [
  { 
    ...
    intro: "תערובת של 10 פירות מובחרים, מיובשים בטכנולוגיה ייחודית ששומרת על הערכים התזונתיים. מספקת את הטוב שבפירות בכמוסה אחת קטנה.",
    image: "assets/cap_fruit.jpg", 
    ingredients: [
      "תפוח", "אפרסק", "חמוציות", "תפוז", "מנגו", 
      "דובדבן אסרולה", "אננס", "שזיף מיובש", "תמר", "סלק", "קליפת לימון"
    ],
    vitamins: ["ויטמין A", "ויטמין C", "ויטמין E", "חומצה פולית"],
    benefits: [
      "תמיכה בבריאות הלב - מחקרים קליניים הוכיחו השפעה חיובית על מדדי בריאות הלב",
      "חיזוק מערכת החיסון - תמיכה בתפקוד מערכת החיסון",
      "תמיכה בבריאות הריאות - מחקר קליני הראה תמיכה בפרמטרים של בריאות הריאות",
      "בריאות העור - מגביר את זרימת הדם הזעירה בעור ומשפר לחות, עובי וצפיפות העור"
    ],
    features: [
      "צמחי וטבעוני",
      "מבוסס מזון שלם",
      "מוכח קלינית ב-40+ מחקרים",
      "ללא גלוטן",
      "מאושר Non-GMO",
      "מאושר כשר",
      "מאושר NSF לאיכות ובטיחות"
    ],
    usage: "2 כמוסות ביום עם ארוחה וכוס מים",
    forWhom: "מתאים לכל מי שרוצה להשלים את צריכת הפירות היומית, לשפר את בריאות הלב, העור ומערכת החיסון."
  },
  { 
    id: "veg", 
    title: "קפסולות ירקות (ירוק)", 
    subTitle: "Vegetable Blend", 
    intro: "תערובת של 10 ירקות ודגנים עשירים בחומרים מזינים, מיובשים בטכנולוגיה ייחודית. מספקת את הטוב שבירקות הירוקים בכמוסה אחת.",
    image: "assets/cap_veg.jpg", 
    ingredients: [
      "ברוקולי", "פטרוזיליה", "עגבניה", "גזר", "שום",
      "דובדבן אסרולה", "סלק", "תרד", "כרוב", "קייל", "סובין אורז", "קליפת לימון"
    ],
    vitamins: ["ויטמין A", "ויטמין C", "ויטמין E", "חומצה פולית"],
    benefits: [
      "תמיכה בבריאות הלב - השפעה חיובית על מדדי בריאות הלב וכלי הדם",
      "חיזוק מערכת החיסון - תמיכה בתפקוד מערכת החיסון",
      "תמיכה בבריאות הריאות - שיפור פרמטרים של תפקוד ריאתי",
      "בריאות העור - שיפור לחות וצפיפות העור"
    ],
    features: [
      "צמחי וטבעוני",
      "מבוסס מזון שלם",
    ...
    usage: "2 כמוסות ביום עם ארוחה וכוס מים",
    forWhom: "מתאים לכל מי שמתקשה לצרוך מספיק ירקות, רוצה לחזק את מערכת החיסון ולתמוך בבריאות הלב."
  },
  { 
    id: "berry", 
    title: "קפסולות פירות יער (סגול)", 
    subTitle: "Berry Blend", 
    intro: "תערובת עוצמתית של 11 סוגי פירות יער וענבים, עשירה בנוגדי חמצון ופוליפנולים. מספקת הגנה תאית ותמיכה בבריאות כללית.",
    image: "assets/cap_berry.jpg", 
    ingredients: [
      "ענבי קונקורד", "רימון", "אוכמניות בילברי", "אוכמניות בלוברי", 
      "אוכמניות שחורות", "סמבוק", "פטל", "חמוציות", 
      "דומדמניות שחורות", "קקאו", "ארטישוק"
    ],
    vitamins: ["ויטמין C", "ויטמין E"],
    benefits: [
      "נוגדי חמצון עוצמתיים - הגנה על התאים מפני נזקי חמצון",
      "תמיכה בבריאות העור - שיפור מראה העור ובריאותו",
      "חיזוק מערכת החיסון - תמיכה בתפקוד מערכת החיסון",
      "תמיכה בבריאות כללית - פוליפנולים התומכים בבריאות הגוף"
    ],
    features: [
      "11 סוגי פירות יער וענבים",
      "עשיר בפוליפנולים",
      "צמחי וטבעוני",
      "מבוסס מזון שלם",
      "ללא גלוטן",
    ...
    usage: "2 כמוסות ביום עם ארוחה וכוס מים",
    forWhom: "מתאים למי שמחפש הגנה אנטי-אוקסידנטית, שיפור בריאות העור והחיסון."
  },
  { 
    id: "omega", 
    title: "קפסולות אומגה", 
    subTitle: "Omega Blend", 
    intro: "תערובת ייחודית של שמנים צמחיים המספקת את כל סוגי האומגה (3, 5, 6, 7, 9) ממקורות צמחיים בלבד - ללא שמן דגים.",
    image: "assets/cap_omega.jpg", 
    ingredients: [
      "שמן אצות (DHA ו-EPA)", "שמן רימונים (אומגה 5)", 
      "שמן אובליפיחה (אומגה 7)", "שמן זרעי פשתן (ALA)",
      "שמן זרעי חרדל", "שמן זרעי כמון שחור", 
      "שמן זרעי אספסת", "שמן זרעי עגבניות", 
      "שמן זרעי גזר", "שמן זרעי פטל"
    ],
    vitamins: ["אומגה 3 (DHA, EPA, ALA)", "אומגה 5", "אומגה 6", "אומגה 7", "אומגה 9", "ויטמין E"],
    benefits: [
      "תמיכה בבריאות המוח והקוגניציה - DHA חיוני לתפקוד המוח",
      "תמיכה בבריאות הלב - אומגה 3 תומכת בבריאות הלב וכלי הדם",
      "תמיכה בבריאות העור - שמנים צמחיים התומכים בלחות ובריאות העור",
      "תמיכה בבריאות העיניים - DHA חיוני לבריאות העיניים"
    ],
    features: [
      "מקור צמחי לאומגה - לא משמן דגים",
      "כל סוגי האומגה: 3, 5, 6, 7, 9",
      "טבעוני לחלוטין",
      "ללא גלוטן",
      "ללא ריח או טעם של דגים"
    ],
    usage: "2 כמוסות ביום עם ארוחה וכוס מים",
    forWhom: "מתאים לטבעונים, צמחונים, ולכל מי שמחפש מקור צמחי לאומגה לתמיכה במוח, לב ועור."
  },
  { 
    id: "vanilla", 
    title: "שייק קומפליט וניל", 
    subTitle: "Complete Vanilla", 
    intro: "ארוחה מלאה בכוס אחת. שייק צמחי עשיר בחלבון, סיבים וויטמינים, עם טעם וניל עדין. מושלם לארוחת בוקר מהירה או חטיף בריא.",
    image: "assets/shake_vanilla.jpg", 
    ingredients: [
      "חלבון סויה מבודד", "סיבים תזונתיים (אינולין)", 
      "תערובת פירות וירקות", "ויטמינים ומינרלים", "תמצית וניל טבעית"
    ],
    vitamins: ["14 גרם חלבון צמחי", "7 גרם סיבים", "ויטמינים ומינרלים"],
    benefits: [
      "תחושת שובע ממושכת - חלבון וסיבים שומרים על שובע לאורך שעות",
      "תמיכה בשמירה על משקל תקין - רק 140 קלוריות למנה",
      "אנרגיה יציבה לאורך היום - פחמימות מורכבות לשחרור אנרגיה הדרגתי",
      "תמיכה בבריאות המעיים - פרה-ביוטיקה (אינולין) לתמיכה בחיידקי המעיים"
    ],
    features: [
      "140 קלוריות למנה",
      "14 גרם חלבון צמחי",
      "7 גרם סיבים (מסיסים ובלתי מסיסים)",
      "צמחי לחלוטין",
      "ללא גלוטן",
      "דל סוכר"
    ],
    usage: "כף מדידה אחת עם 250 מ\"ל מים או חלב צמחי. ניתן להוסיף פירות או קרח.",
    forWhom: "מתאים לארוחת בוקר מהירה, חטיף לאחר אימון, או תחליף ארוחה לשמירה על משקל."
  },
  { 
    id: "choco", 
    title: "שייק קומפליט שוקולד", 
    subTitle: "Complete Chocolate", 
    intro: "ארוחה מלאה בכוס אחת עם טעם שוקולד עשיר. שייק צמחי עשיר בחלבון, סיבים וויטמינים. מושלם לחובבי השוקולד שרוצים לאכול בריא.",
    image: "assets/shake_choco.jpg", 
    ingredients: [
      "חלבון סויה מבודד", "קקאו הולנדי", "סיבים תזונתיים (אינולין)", 
      "תערובת פירות וירקות", "ויטמינים ומינרלים"
    ],
    vitamins: ["13 גרם חלבון צמחי", "7 גרם סיבים", "ויטמינים ומינרלים"],
    benefits: [
      "תחושת שובע ממושכת - חלבון וסיבים שומרים על שובע לאורך שעות",
      "אנרגיה יציבה - פחמימות מורכבות וקקאו לאנרגיה מאוזנת",
      "תמיכה בשמירה על משקל תקין - רק 140 קלוריות למנה",
      "תמיכה בבריאות המעיים - פרה-ביוטיקה לתמיכה בחיידקי המעיים"
    ],
    features: [
      "140 קלוריות למנה",
      "13 גרם חלבון צמחי",
    ...
    usage: "כף מדידה אחת עם 250 מ\"ל מים או חלב צמחי. ניתן להוסיף בננה או חמאת בוטנים.",
    forWhom: "מתאים לחובבי שוקולד שרוצים ארוחה בריאה, לאחר אימון, או כתחליף ארוחה."
  }
];
