/* data.js
   FINAL FIX - EXACT RESTORATION FROM SCREENSHOT
   1. SC TREE: Rebuilt exactly to match "Screenshot 2026-01-11".
      - 7 Direct Legs.
      - Specific PVs (2561, 4300, 930, etc.).
      - 3 Generations depth.
   2. TEXTS: Restored "Split Payment" notes (1200 + 2400).
...
window.PRODUCTS = [
  {
    ...
    benefits: ["מגשר על הפער התזונתי.", "ויטמין A לבריאות העור.", "ויטמין C לייצור קולגן."],
  ...
  },
  {
    ...
    ingredients: "ענבים, אוכמניות כחולות, חמוציות, אוכמניות שחורות, בלאק קורנט, בילברי, פטל, רימון, סמבוק, קקאו וארטישוק.",
  ...
  },
  {
    ...
    ingredients: "שמן אצות, שמן זרעי רימונים, פטל, אשחר ים, חריע ועגבניות.",
    vitamins: "אומגה 3, 5, 6, 7 ו-9.",
    benefits: ["מופק בכבישה קרה.", "ללא טעם לוואי דגי.", "תמיכה במוח ובלב."],
    usage: "2 קפסולות ביום."
  },
  {
    id: "vanilla",
    ...
    ingredients: "חלבון סויה, אפונה, אורז, חומוס (13 גרם חלבון).",
    vitamins: "ויטמינים ומינרלים מלאים.",
    benefits: ["אינדקס גליקמי נמוך.", "עשיר בסיבים.", "ללא גלוטן."],
  ...
  },
  {
    ...
    ingredients: "חלבון סויה, אפונה, אורז, חומוס וקקאו.",
    vitamins: "ויטמינים ומינרלים מלאים.",
...
// --- 4. עצי דרגות (שיחזור מדויק לפי צילום המסך של ה-SC) ---
window.RANK_TREES = {
  // P+ : פשוט ומדויק
  partner_plus: {
    title: "מבנה Partner Plus (P+)",
    ...
    notes: ["הושג היעד: 4,576 נקודות (מעל 4,000)."]
  },
  ...
  // SC: השחזור המדויק מהתמונה ששלחת!
  sales_coordinator: {
    ...
    nodes: [
      ...
      // שורה ראשונה (7 רגליים פרוסות לרוחב)
